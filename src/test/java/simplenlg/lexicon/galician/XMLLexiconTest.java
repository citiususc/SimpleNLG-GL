...
public class XMLLexiconTest {
    ...
    public void xmlLexiconImmutabilityTest() {
        ...
        // "wall" is singular.
        NPPhraseSpec pared = factory.createNounPhrase("a", "parede");
        ...
        SPhraseSpec sentence = factory.createClause("movemento", "observar");
        ...
        pared = factory.createNounPhrase("a", "parede");
        Assert.assertEquals(NumberAgreement.SINGULAR, pared.getFeature(Feature.NUMBER));
    }
