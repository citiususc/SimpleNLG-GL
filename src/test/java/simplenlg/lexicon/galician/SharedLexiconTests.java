...
public class SharedLexiconTests {
    ...
    public void doBasicTests(Lexicon lexicon) {
        ...
        Assert.assertEquals("mellor", bueno
                .getFeatureAsString(LexicalFeature.COMPARATIVE));
        Assert.assertEquals("boísimo", bueno
        ...
        Assert.assertEquals("mulleres", mujer
        ...
        WordElement arena = lexicon.getWord("area", LexicalCategory.NOUN);
        ...
        // test hasWord
        Assert.assertEquals(true, lexicon.hasWord("árbore")); // "tree" exists
        Assert.assertEquals(false, lexicon.hasWord("árbore",
        ...
        WordElement comer = lexicon.getWordFromVariant("comendo");
        ...
        Assert.assertEquals(lexicon.lookupWord("say", LexicalCategory.VERB)
                .getBaseForm(), "say");
        Assert.assertEquals(lexicon.lookupWord("dito", LexicalCategory.VERB)
                .getBaseForm(), "say");
