...
public class DeterminerTest {
    ...
    @Before
    public void setUp() {
        this.lexicon = new simplenlg.lexicon.galician.XMLLexicon();  // built in lexicon
    ...
    public void testIrregularSubjects() {
        ...
        NPPhraseSpec subject = this.phraseFactory.createNounPhrase("un", "un");
        sentence.setSubject(subject);

        String output = this.realiser.realiseSentence(sentence);

        Assert.assertEquals("Un un.", output);
    }
    ...
    public void testPluralThisDeterminerNPObject() {
        ...
        Assert.assertEquals("Estes monos.", this.realiser.realiseSentence(sentence_1));
    ...
    public void testPluralThatDeterminerNPObject() {
        ...
        Assert.assertEquals("Eses monos.", this.realiser.realiseSentence(sentence_1));
    ...
    public void testSingularThoseDeterminerNPObject() {
        ...
        nounPhrase_1.setDeterminer("eses");
        sentence_1.setObject(nounPhrase_1);
