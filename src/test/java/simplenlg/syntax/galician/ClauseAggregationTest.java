...
public class ClauseAggregationTest extends SimpleNLG4Test {
    ...
    protected void setUp() {
        ...
        this.s4.setObject(this.phraseFactory.createNounPhrase("o", "can"));
        ...
        this.s5.setSubject(this.phraseFactory.createNounPhrase("o", "neno")); //$NON-NLS-1$
        ...
        this.s5.setObject(this.phraseFactory.createNounPhrase("o", "can"));
        ...
        this.s6.setSubject(this.phraseFactory.createNounPhrase("o", "muller")); //$NON-NLS-1$
        this.s6.setVerbPhrase(this.phraseFactory.createVerbPhrase("bicar")); //$NON-NLS-1$
        this.s6.setObject(this.phraseFactory.createNounPhrase("o", "can"));
...
//	}
    ...
    public void testCoordinationWithModifiers() {
        ...
        this.s3.addFrontModifier(this.phraseFactory
                .createAdverbPhrase("sen embargo"));
