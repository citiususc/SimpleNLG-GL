...
public class OrthographyFormatTest extends SimpleNLG4Test {
    ...
    public void testAppositivePreModifiers() {
        NPPhraseSpec subject = this.phraseFactory.createNounPhrase("eu");
        NPPhraseSpec object = this.phraseFactory.createNounPhrase("unha bolsa");
        ...
        PPPhraseSpec pp = this.phraseFactory.createPrepositionPhrase("en",
                this.phraseFactory.createNounPhrase("a maioría dos", "martes"));
        _s1.addPreModifier(pp);

        //without appositive feature on pp
        Assert.assertEquals(
                "eu na maioría dos martes levo unha bolsa", this.realiser
    ...
    public void testCommaSeparatedFrontModifiers() {
        ...
        Assert.assertEquals(
                "na maioría dos martes desde 1991 eu levo unha bolsa", this.realiser
                        .realise(_s1).getRealisation());
    ...
    public void testNoDoubledCommas() {
        ...
        PPPhraseSpec pp3 = this.phraseFactory.createPrepositionPhrase("excepto",
                this.phraseFactory.createNounPhrase("onte"));
        ...
        Assert.assertEquals(
                "na maioría dos martes, desde 1991, excepto onte, eu levo unha bolsa", this.realiser
                        .realise(_s1).getRealisation());
