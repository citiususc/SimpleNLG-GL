 ...
 */
package simplenlg.lexicon.galician;
...
public class XMLLexicon extends simplenlg.lexicon.XMLLexicon {
    ...
    public XMLLexicon(String filename) {
        ...
        super(filename, Language.GALICIAN);
        this.PLURAL_COORDINATORS.addAll(Arrays.asList("e", "ou"));
    }
    ...
    public XMLLexicon(URI lexiconURI) {
        ...
        super(lexiconURI, Language.GALICIAN);
        this.PLURAL_COORDINATORS.addAll(Arrays.asList("e", "ou"));
    }

    public XMLLexicon() {

        super(Language.GALICIAN);
        this.PLURAL_COORDINATORS.addAll(Arrays.asList("e", "ou"));
    }
...
//                    variants.add(getVariant(word, LexicalFeature.COMPARATIVE, "er"));
                ...
                case VERB:
                    ...
                    variants.add(getVariant(word, LexicalFeature.FUTURESUBJUNCTIVE1S, ""));
                    variants.add(getVariant(word, LexicalFeature.FUTURESUBJUNCTIVE2S, ""));
                    variants.add(getVariant(word, LexicalFeature.FUTURESUBJUNCTIVE3S, ""));
                    variants.add(getVariant(word, LexicalFeature.FUTURESUBJUNCTIVE1P, ""));
                    variants.add(getVariant(word, LexicalFeature.FUTURESUBJUNCTIVE2P, ""));
                    variants.add(getVariant(word, LexicalFeature.FUTURESUBJUNCTIVE3P, ""));

                    variants.add(getVariant(word, LexicalFeature.CONJINFINITIVE1S, ""));
                    variants.add(getVariant(word, LexicalFeature.CONJINFINITIVE2S, ""));
                    variants.add(getVariant(word, LexicalFeature.CONJINFINITIVE3S, ""));
                    variants.add(getVariant(word, LexicalFeature.CONJINFINITIVE1P, ""));
                    variants.add(getVariant(word, LexicalFeature.CONJINFINITIVE2P, ""));
                    variants.add(getVariant(word, LexicalFeature.CONJINFINITIVE3P, ""));
                    break;
    ...
    public WordElement getAdditionCoordConjunction() {
        return lookupWord("e", LexicalCategory.CONJUNCTION);
    }
