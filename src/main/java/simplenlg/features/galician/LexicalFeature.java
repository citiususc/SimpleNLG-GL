...
package simplenlg.features.galician;
...
public abstract class LexicalFeature extends simplenlg.features.LexicalFeature {
    ...
    public static final String PLUPERFECT1S = "pluperfect1s";
    public static final String PLUPERFECT2S = "pluperfect2s";
    public static final String PLUPERFECT3S = "pluperfect3s";
    public static final String PLUPERFECT1P = "pluperfect1p";
    public static final String PLUPERFECT2P = "pluperfect2p";
    public static final String PLUPERFECT3P = "pluperfect3p";
    ...
    public static final String IMPERFECTSUBJUNCTIVE1S = "imperfectsubjunctive1s";
    public static final String IMPERFECTSUBJUNCTIVE2S = "imperfectsubjunctive2s";
    public static final String IMPERFECTSUBJUNCTIVE3S = "imperfectsubjunctive3s";
    public static final String IMPERFECTSUBJUNCTIVE1P = "imperfectsubjunctive1p";
    public static final String IMPERFECTSUBJUNCTIVE2P = "imperfectsubjunctive2p";
    public static final String IMPERFECTSUBJUNCTIVE3P = "imperfectsubjunctive3p";
    ...
    public static final String FUTURESUBJUNCTIVE1S = "futuresubjunctive1s";
    public static final String FUTURESUBJUNCTIVE2S = "futuresubjunctive2s";
    public static final String FUTURESUBJUNCTIVE3S = "futuresubjunctive3s";
    public static final String FUTURESUBJUNCTIVE1P = "futuresubjunctive1p";
    public static final String FUTURESUBJUNCTIVE2P = "futuresubjunctive2p";
    public static final String FUTURESUBJUNCTIVE3P = "futuresubjunctive3p";

    public static final String CONJINFINITIVE1S = "conjinfinitive1s";
    public static final String CONJINFINITIVE2S = "conjinfinitive2s";
    public static final String CONJINFINITIVE3S = "conjinfinitive3s";
    public static final String CONJINFINITIVE1P = "conjinfinitive1p";
    public static final String CONJINFINITIVE2P = "conjinfinitive2p";
    public static final String CONJINFINITIVE3P = "conjinfinitive3p";

    public static final String CONJGEROUND1S = "conjgeround1s";
    public static final String CONJGEROUND2S = "conjgeround2s";
    public static final String CONJGEROUND3S = "conjgeround3s";
    public static final String CONJGEROUND1P = "conjgeround1p";
    public static final String CONJGEROUND2P = "conjgeround2p";
    public static final String CONJGEROUND3P = "conjgeround3p";
}
